...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < stockIds.size(); i++) {
            ...
            // **Updated to use compareFloats**
            compareFloats(stockmanger.getStockPrice(stockIds.get(i)), prices.get(i));
        }
        ...
        Assert(stockamount == 4);

        System.out.println(stockamount);
        String[] stocksInRange = stockmanger.getStocksInPriceRange(price1, price2);
        Assert(stocksInRange[0] == ("YZABCD"));
        Assert(stocksInRange[1] == ("KLMNOP"));
        Assert(stocksInRange[2] == ("WXYZAB"));
        Assert(stocksInRange[3] == ("EFGHIJ"));
